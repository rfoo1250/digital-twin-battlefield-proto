...
"""
Army:
group of squadrons that act under single command, moves slow, attack range very limited, no fuel consumption

currently modeled after Ship.py (will behave like a ship)
note:
if motorized, fuel consumption?
"""
